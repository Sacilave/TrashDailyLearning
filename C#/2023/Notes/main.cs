// namespace 和 class 概念
using System;  // 此操作为引用 namespace，比如 System 就属于一个 namespace
// 引用 namespace 时需要注意是否会导致 class 的冲突，比如两个namespace中有两个相同的class
// namespace 在 VS 中图标为 {}, class 图标为一个黄色树形结构
namespace Learn2023
{
    class Program
    {
        static void Main()
        {
            Console.WriteLine();  // Console 属于一个类，属于 System 这一 namespace 中
