...
class MyPlane(pygame.sprite.Sprite):
    ...
    def add_down_img(self):
        """我方飞机爆炸动画"""
        bomb_img = pygame.image.load("images/boom_100.png").convert_alpha()
        for i in range(6):
...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def add_down_img(self):
        """敌方中飞机爆炸动画，使用中爆炸特效图片"""
        bomb_img = pygame.image.load("images/boom_200.png").convert_alpha()
        for i in range(6):
            # 特效图片有6部分
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, screen_size):
        super().__init__()
        image_file = "images/big_enemy" + str(random.randint(1, 3)) + ".png"
        self.image = pygame.image.load(image_file).convert_alpha()
        self.rect = self.image.get_rect()
        self.mask = pygame.sprite.from_surface(self.image)
        # 游戏窗口的宽和高
    ...
    def add_down_img(self):
        ...
        bomb_img = pygame.image.load("images/boom_300.png").convert_alpha()
        for i in range(6):
