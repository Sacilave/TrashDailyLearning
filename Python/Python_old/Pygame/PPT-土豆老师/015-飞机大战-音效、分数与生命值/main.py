...
def show_score(text):
    """显示分数"""
    font = pygame.font.Font("font/font.ttf", 40)  # 获取字体，并设置文字大小
    score_text = font.render("SCORE: "+text, True, (255, 255, 255))  # 设置文字内容
    screen.blit(score_text, (10, 10))  # 绘制文字


def show_life(hp):
    """显示飞机生命值"""
    font = pygame.font.Font("font/font.ttf", 40)  # 获取字体，并设置文字大小
    score_text = font.render("LIFE: "+str(hp), True, (255, 255, 255))  # 设置文字内容
    screen.blit(score_text, (width-150, 10))  # 绘制文字
